...
dist/sipstuff-$(VERSION).tar.gz dist/sipstuff-$(VERSION)-py3-none-any.whl dist/.touchfile: $(PKG_SOURCES) $(VENV_DEPS) pyproject.toml
...
DOCKER_IMAGE := xomoxcc/sipstuff

copy-pjsua2:
	bash dist_scripts/copy_pjsua2_from_docker.sh
